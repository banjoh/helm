...
// encodeReleaseV2 encodes a v2 release returning a base64 encoded
// gzipped string representation, or error.
func encodeReleaseV2(rls *v2rspb.Release) (string, error) {
	b, err := json.Marshal(rls)
	if err != nil {
		return "", err
	}
...
// decodeReleaseV2 decodes the bytes of data into a v2 release
// type. Data must contain a base64 encoded gzipped string of a
// valid release, otherwise an error is returned.
func decodeReleaseV2(data string) (*v2rspb.Release, error) {
	// base64 decode string
	b, err := b64.DecodeString(data)
	if err != nil {
		return nil, err
